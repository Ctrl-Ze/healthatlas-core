...
-- NOTE: panel_group is for temporary grouping in development.
-- TODO To be normalized (panels + panel_analytes) before production.
CREATE TABLE analytes (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
    name TEXT NOT NULL UNIQUE,     -- e.g., "HGB"
